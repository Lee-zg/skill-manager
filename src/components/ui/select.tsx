...
export function SelectTrigger({
  ...
  return (
    <RadixSelect.Trigger
      className={cn(
        'flex h-8 items-center justify-between gap-1.5 rounded-md border border-[var(--color-border)]',
        'bg-[var(--color-bg-surface)] px-2.5 text-xs text-[var(--color-text-secondary)]',
...
export function SelectItemEl({
  ...
  return (
    <RadixSelect.Item
      className={cn(
        'relative flex cursor-pointer select-none items-center rounded-md px-3 py-1.5 text-xs outline-none',
